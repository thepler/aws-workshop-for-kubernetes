...
| *Oregon* (us-west-2)
a| image::./deploy-to-aws.png[link=https://console.aws.amazon.com/cloudformation/home?region=us-west-2#/stacks/new?stackName=k8s-workshop&templateURL=https://205675256514-cfn-templates.s3.amazonaws.com/cloud9.json]

| *Ohio* (us-east-2)
a| image::./deploy-to-aws.png[link=https://console.aws.amazon.com/cloudformation/home?region=us-east-2#/stacks/new?stackName=k8s-workshop&templateURL=https://205675256514-cfn-templates.s3.amazonaws.com/cloud9.json]

| *Ireland* (eu-west-1)
a| image::./deploy-to-aws.png[link=https://console.aws.amazon.com/cloudformation/home?region=eu-west-1#/stacks/new?stackName=k8s-workshop&templateURL=https://205675256514-cfn-templates.s3.amazonaws.com/cloud9.json]
...
`git clone git@github.com:dewjam/aws-workshop-for-kubernetes.git`
...
```
cd aws-workshop-for-kubernetes/01-container-basics/utilities
docker build -t utilities .
```

Run the Utilities image
`docker run -it -v ~/.aws/:/root/.aws -v ~/.kube/:/root/.kube utilities`
