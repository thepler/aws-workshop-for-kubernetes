...
To launch your worker nodes, first set the EKS_NODE_STACK_NAME environmental variable.  Make sure the stack name is unique.

    $ EKS_NODE_STACK_NAME=<your_unique_stack_name>

Then run the following CloudFormation CLI command:
